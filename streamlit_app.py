...
if submit:
    ...
    try:
        ...
        # --- 3. ตัดสินใจระดับความเสี่ยง (ปรับเกณฑ์ใหม่เพื่อให้เห็นสีเหลืองในการพรีเซนต์) ---
        # ถ้าเข้าเกณฑ์คลินิก (ก้อนใหญ่/EMR/ติดคลิป) = แดงทันที
        ...
        # ถ้าคะแนน AI เกิน 0.02 (ซึ่งเคสส่วนใหญ่ที่คุณคีย์จะตกช่วงนี้) = เหลือง
        elif prob >= 0.02: 
